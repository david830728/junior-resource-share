              ...
              return (
                <div key={chNum}>
                  ...
                  {expanded && sections.map(sec => (
                    <div key={sec.id} className={`${rowClass} pl-8`}>
                      {editState && !editState.isChapterEdit && editState.id === sec.id ? (
                        <>
                          <input
                            ...
                            placeholder="编号"
                            className="w-16 px-2 py-0.5 border border-blue-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-blue-200"
                          />
                          <input
